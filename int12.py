  ...
  #                      interest = allY[x]
   #                     for i in interest:
    #                            
        ...
        numpy.save('int12dict', allValues)
        int11 = numpy.load('int12dict.npy').item()
        #print(stack)
...
stack()
import numpy
int12 = numpy.load('int12dict.npy').item()
#print(int12)
